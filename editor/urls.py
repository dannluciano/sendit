...
urlpatterns = [
    ...
    path('files/<str:file_code_uuid>/',
         views.file_code_detail, name='file-code-detail'),
    path('files/<str:file_code_uuid>/destroy/',
         views.file_code_destroy, name='file-code-destroy'),
