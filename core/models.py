...
class Submission(models.Model):
    ...
    def get_absolute_url(self):
        if self.is_waiting:
            return reverse("core:submissions-status", args=[self.uuid])
        return reverse("core:submissions-detail", args=[self.uuid])
