...
urlpatterns = [
    path('', auth_views.LoginView.as_view(template_name='platform/index.html',
                                          redirect_authenticated_user=True, redirect_field_name='next'), name='index'),
    ...
    path('questions/<int:question_id>/submit/',
         views.create_submission, name='submit'),
